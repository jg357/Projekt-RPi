...
//Activity fuer die 7 Tage Luftfeuchtigkeit Chart Activity
public class HumChart7d extends Activity implements SimpleGestureListener{
	...
	private String[] mMonth = new String[] {
	 ...
	 private void OpenChart()
	    {
	     ...
	     XYSeries xSeries=new XYSeries("Luftfeuchtigkeit");
	 ...
	 dataset.addSeries(xSeries);
	     ...
	     mRenderer.setChartTitle("Luftfeuchtigkeit 7 Tage");
	    ...
	    @Override
	     public void onSwipe(int direction) {
	      ...
	      case SimpleGestureFilter.SWIPE_LEFT :  //str = "Swipe Left";
	    	  ...
	    	  startActivity(new Intent(this,TempChart7d.class));
	 ...
	 class ClientThread implements Runnable {
			...
			public void run() {
				try {
					...
					out.println("HumChart7d!"); // Gibt den Pi den Befehl die Chart Werte zu uebertragen!
					out.flush();
				...
				try {
					while (i) {		// Solange die Activity aktiv ist werden mit dem BufferdReader
						...
						if (line != null) {
							Log.d("MyApp", line);						
						    if(line.contains("Humchart7d:")){	// Wenn die Nachricht HumChart7d vom Pi kommt so
						    	Log.d("MyApp", line);			
