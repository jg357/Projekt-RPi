...
//Activity fuer die 3 Tage Temperatur Chart Activity
public class TempChart3d extends Activity implements SimpleGestureListener{
	...
	private String[] mMonth = new String[] {
	 ...
	 private void OpenChart()
	    {
	     ...
	     XYSeries xSeries=new XYSeries("Temperatur");
	 ...
	 dataset.addSeries(xSeries);
	     ...
	     mRenderer.setChartTitle("Temperatur 3 Tage");
	    ...
	    // Methode fuer den Swipe
	     public void onSwipe(int direction) {
	      ...
	      case SimpleGestureFilter.SWIPE_LEFT :  
	    	  ...
	    	  startActivity(new Intent(this,HumChart24h.class));
	 ...
	 class ClientThread implements Runnable {
			...
			public void run() {
				try {
					...
					out.println("TempChart3d!");	// Gibt den Pi den Befehl die Chart Werte zu uebertragen!
					out.flush();
				...
				try {
					while (i) {		// Solange die Activity aktiv ist werden mit dem BufferdReader
						...
						if (line != null) {
							Log.d("MyApp", line);						
						    if(line.contains("TempChart3d:")){	// Wenn die Nachricht TempChart3d vom Pi kommt so
						    	Log.d("MyApp", line);
