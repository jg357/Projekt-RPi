...
//Activity fuer die 3 Tage Luftfeuchtigkeit Chart Activity
public class HumChart3d extends Activity implements SimpleGestureListener{
	...
	private String[] mMonth = new String[] {
	 ...
	 dataset.addSeries(xSeries);
	     ...
	     mRenderer.setChartTitle("Luftfeuchtigkeit 3 Tage");
	 ...
	 class ClientThread implements Runnable {
			...
			public void run() {
				try {
					...
					out.println("HumChart3d!");  // Gibt den Pi den Befehl die Chart Werte zu uebertragen!
					out.flush();
				...
				try {
					while (i) {		// Solange die Activity aktiv ist werden mit dem BufferdReader
						...
						if (line != null) {
							Log.d("MyApp", line);						
						    if(line.contains("Humchart3d:")){	// Wenn die Nachricht HumChart3d vom Pi kommt so
						    	Log.d("MyApp", line);			
